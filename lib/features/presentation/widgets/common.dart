...
void snackBarNetwork({String? msg, GlobalKey<ScaffoldMessengerState>? scaffoldState}) {
...
void snackBar({required String msg, required GlobalKey<ScaffoldMessengerState> scaffoldState}) {
  scaffoldState.currentState!.showSnackBar(
    SnackBar(
      content: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
